                            ...
                            <form action="/anggota/update/{{$id}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="anggota_tempatlhr" required name="anggota_tempatlhr"
                                        value="{{ $anggota->anggota_tempatlhr }}">
                                </div>
                                <hr>
                                {{-- tgl lahir --}}
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="anggota_pasangan" required name="anggota_pasangan"
                                        value="{{ $anggota->anggota_pasangan }}">
                                </div>
                                <hr>
                                {{-- pekerjaan --}}
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="anggota_pekerjaan" required name="anggota_pekerjaan"
                                        value="{{ $anggota->anggota_pekerjaan }}">
                                </div>
                                <hr>
                                {{-- alamat --}}
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="anggota_nohp" required name="anggota_nohp"
                                        value="{{ $anggota->anggota_nohp }}">
                                </div>
                                <hr>
                                {{-- email --}}
                                <div class="form-group">
                                    <label for="anggota_email">Email</label>
                                    <input type="text" class="form-control" id="anggota_email" required name="anggota_email"
                                        value="{{ $anggota->anggota_email }}">
                                </div>
                                <hr>
                                {{-- anak --}}
                                <div class="form-group">
                                    <label for="anggota_anak">Jumlah Anak</label>
                                    <input type="text" class="form-control" id="anggota_anak" required name="anggota_anak"
                                        value="{{ $anggota->anggota_anak }}">
                                </div>
                                <hr>
                                {{-- ktp --}}
                                <div class="form-group">
                                    <label for="anggota_ktp">No KTP</label>
                                    <input type="text" class="form-control" id="anggota_ktp" required name="anggota_ktp"
                                        value="{{ $anggota->anggota_ktp }}">
                                </div>
                                <hr>
                                {{-- npwp --}}
                                <div class="form-group">
                                    <label for="anggota_npwp">No NPWP</label>
                                    <input type="text" class="form-control" id="anggota_npwp" required name="anggota_npwp"
                                        value="{{ $anggota->anggota_npwp }}">
                                </div>
                                <hr>
                                {{-- bpjs --}}
                                <div class="form-group">
                                    <label for="anggota_bpjs">No BPJS</label>
                                    <input type="text" class="form-control" id="anggota_bpjs" required name="anggota_bpjs"
                                        value="{{ $anggota->anggota_bpjs }}">
                                </div>
                                <hr>
