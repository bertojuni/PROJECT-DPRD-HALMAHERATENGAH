...
@section('content')
                                ...
                                @foreach ($anggota as $p)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div onclick="deleteModal({{ $p->anggota_id }})"
                    ...
                    <div class="modal-body">
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="anggota_ktp" required name="anggota_ktp">
                            </div>

                            <div class="form-group">
                                <label for="anggota_npwp">No NPWP</label>
                                <input type="number" class="form-control" id="anggota_npwp" required name="anggota_npwp">
                            </div>

                            <div class="form-group">
                                <label for="anggota_bpjs">No BPJS</label>
                                <input type="number" class="form-control" id="anggota_bpjs" required name="anggota_bpjs">
                            </div>
    ...
    <div class="modal fade" id="deleteDataAnggota" data-backdrop="static" data-keyboard="false" tabindex="-1"
        aria-labelledby="deleteDataAnggotaLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
