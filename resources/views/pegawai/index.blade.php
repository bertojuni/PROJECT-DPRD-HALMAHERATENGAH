...
@section('content')
                                ...
                                @foreach ($pegawai as $p)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div onclick="deleteModal({{ $p->pg_id }})"
                    ...
                    <div class="modal-body">
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="pg_karpeg" required name="pg_karpeg">
                            </div>

                            <div class="form-group">
                                <label for="pg_ktp">No KTP</label>
                                <input type="number" class="form-control" id="pg_ktp" required name="pg_ktp">
                            </div>

                            <div class="form-group">
                                <label for="pg_npwp">No NPWP</label>
                                <input type="number" class="form-control" id="pg_npwp" required name="pg_npwp">
                            </div>

                            <div class="form-group">
                                <label for="pg_bpjs">No BPJS</label>
                                <input type="number" class="form-control" id="pg_bpjs" required name="pg_bpjs">
                            </div>
    ...
    <div class="modal fade" id="deleteDataPegawai" data-backdrop="static" data-keyboard="false" tabindex="-1"
        aria-labelledby="deleteDataPegawaiLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
